...
function LikeIcon({fill, like}: fill) {
  return (
    <svg onClick={like} className="self-end" width="16" height="14" viewBox="0 0 16 14" fill={!fill ? 'none' : '#512689'} xmlns="http://www.w3.org/2000/svg">
